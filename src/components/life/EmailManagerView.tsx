...
export const EmailManagerView: React.FC<EmailManagerViewProps> = ({
  ...
  return (
    <div className={`space-y-4 relative ${isCompact ? 'p-1' : ''}`}>
      {/* 토스트 알림 */}
      {toastMessage && (
        ...
        <div>
          <div className="flex items-center space-x-2">
            <h2 className="text-base sm:text-lg font-bold flex items-center space-x-2 text-slate-900 dark:text-white whitespace-nowrap">
              ...
              <span className="whitespace-nowrap">4. ✉️ 이메일 수퍼휴먼 인박스</span>
        ...
        <div className="space-y-3">
          {filteredEmails.map((mail) => (
            <div
              ...
              className={`p-4 rounded-xl border transition-all cursor-pointer shadow-xs flex flex-col gap-2.5 ${
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center space-x-2 min-w-0">
                  <div className="w-7 h-7 rounded-full bg-slate-100 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 flex items-center justify-center text-xs font-bold text-slate-700 dark:text-slate-300 shrink-0">
                  ...
                  <div className="flex items-center space-x-1.5 shrink-0 ml-1">
                    ...
                    {mail.attachments && mail.attachments.length > 0 && (
                      <span className="px-1.5 py-0.5 rounded text-[10px] font-semibold bg-slate-100 text-slate-600 dark:bg-neutral-800 dark:text-neutral-300 border border-slate-200 dark:border-neutral-700 flex items-center space-x-1 whitespace-nowrap">
                ...
                <div className="flex items-center space-x-2 shrink-0">
                  <span className="text-[11px] text-slate-400 dark:text-neutral-400 whitespace-nowrap">
                    {mail.time}
                  </span>
                  {/* 빠른 액션 버튼들 */}
              ...
              {/* AI 1줄 요약 */}
              <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-neutral-950/60 border border-slate-200/60 dark:border-neutral-800/60 flex items-start space-x-2">
