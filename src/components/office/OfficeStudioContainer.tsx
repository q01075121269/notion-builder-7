      ...
      <div className={`h-12 border-b ${themeConfig.headerBorder} ${themeConfig.headerBg} backdrop-blur px-3 sm:px-5 flex items-center justify-between shrink-0 z-20 gap-3 no-print shadow-2xs transition-colors duration-200`}>
        ...
        <div className="flex items-center space-x-1.5 overflow-x-auto whitespace-nowrap scrollbar-none flex-1 min-w-0 py-0.5">
          ...
          <button
            ...
            className={`p-1.5 rounded-lg border transition cursor-pointer shrink-0 shadow-2xs ${themeConfig.pillBg} ${themeConfig.pillBorder} ${themeConfig.textPrimary} hover:opacity-80`}
            title={isCollapsed ? '지식 창고 펼치기' : '지식 창고 접기 (전폭 캔버스)'}
          >
            {isCollapsed ? <PanelLeftOpen className="w-3.5 h-3.5 text-cyan-400" /> : <PanelLeftClose className="w-3.5 h-3.5 text-slate-400" />}
          </button>
        ...
        <div className="flex items-center space-x-2 shrink-0">
          <div className="hidden lg:flex items-center space-x-1.5 text-xs text-slate-600 dark:text-slate-300 font-medium">
