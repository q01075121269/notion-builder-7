    ...
    <>
      <header className="sticky top-0 z-50 w-full h-14 bg-gradient-to-r from-zinc-100 via-slate-100 to-zinc-200 dark:from-zinc-900 dark:via-zinc-850 dark:to-zinc-800 border-b border-zinc-300 dark:border-zinc-700 transition-colors select-none overflow-visible">
        <div className="w-full max-w-[1600px] mx-auto px-2 sm:px-4 h-full flex items-center justify-between gap-1.5 sm:gap-3 flex-nowrap overflow-visible relative z-50">
          ...
          {/* [중앙]: [템플릿 마스터 | 라이프 Hub | 오피스 스튜디오 | AI 미디어 랩] 4대 메인 탭 (모노톤 & 메탈릭) */}
          <div className="flex items-center bg-zinc-200/70 dark:bg-zinc-800/80 p-1 rounded-xl border border-zinc-300 dark:border-zinc-700 shrink-0 gap-0.5 sm:gap-1">
            ...
            <button
              ...
              title="템플릿 마스터"
            >
              <LayoutTemplate className="w-4 h-4 mr-1.5 text-slate-500 shrink-0" />
            ...
            <button
              ...
              title="라이프 Hub & 루틴 관리"
            >
              <Compass className="w-4 h-4 mr-1.5 text-slate-500 shrink-0" />
            ...
            <button
              ...
              title="오피스 스튜디오"
            >
              <Briefcase className="w-4 h-4 mr-1.5 text-slate-500 shrink-0" />
            ...
            <button
              ...
              title="AI 미디어 랩"
            >
              <Film className="w-4 h-4 mr-1.5 text-slate-500 shrink-0" />
              <span className="whitespace-nowrap">AI 미디어 랩</span>
            </button>
          </div>

          {/* [우측]: [통합 허브] + [루틴 브리핑], Gemini 모델 셀렉터, [설정] 버튼, 프로필 아바타 */}
          <div className="flex items-center space-x-1 sm:space-x-1.5 shrink-0 whitespace-nowrap pr-1 relative z-50 overflow-visible">
            ...
            <button
              ...
              className="flex items-center px-3 py-1.5 rounded-lg text-xs font-medium bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200 transition-colors shadow-xs cursor-pointer border border-zinc-700 dark:border-zinc-300 shrink-0 tracking-tight"
              title="내 노션 통합 허브 워크스페이스 새 탭 열기"
            >
              <Layers className="w-4 h-4 mr-1.5 text-slate-300 shrink-0" />
              <span className="whitespace-nowrap">통합 허브</span>
              <ExternalLink className="w-3 h-3 opacity-70 shrink-0 text-zinc-300 dark:text-zinc-600 ml-1" />
            </button>

            {/* 데일리 루틴 퀵 버튼 */}
            <button
              onClick={handleDailyRoutine}
              className="flex items-center px-2 sm:px-2.5 py-1.5 rounded-xl border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700/80 text-zinc-700 dark:text-zinc-200 text-xs font-semibold transition whitespace-nowrap shadow-xs cursor-pointer active:scale-95 shrink-0"
              title="오늘의 데일리 루틴 브리핑"
            >
              <SunMedium className="w-4 h-4 mr-1.5 text-slate-600 dark:text-slate-300 shrink-0" />
            ...
            <button
              ...
              className="relative flex items-center px-2 sm:px-2.5 py-1.5 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-700/80 text-neutral-700 dark:text-neutral-200 text-xs font-semibold transition whitespace-nowrap shadow-xs cursor-pointer active:scale-95 shrink-0"
              title="설정 및 외부 연동 관리 열기"
            >
              <Settings className="w-4 h-4 mr-1 text-slate-500 shrink-0" />
