...
- [★매우 중요: 일정 연기 및 변경(Reschedule) 규칙]
  사용자가 "21일 일정을 28일로 연기해줘", "21일 회의를 28일로 미뤄줘" 등 기존 일정을 다른 날짜로 이동/연기하는 명령을 내린 경우:
  신규 일정을 생성하는 것이 아니라 기존 일정을 갱신하는 것이므로,
  intent: "schedule", properties에 '액션': 'reschedule', '기존날짜': '2026-09-21', '변경날짜': '2026-09-28', '일정': '2026-09-28', '날짜': '2026-09-28'를 정확히 명시하세요.
